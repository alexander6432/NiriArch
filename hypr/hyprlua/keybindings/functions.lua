...
hl.bind(
	...
	hl.dsp.exec_cmd(volume_increase),
	{ locked = true, repeating = true, desc = "Aumentar el volumen" }
)
hl.bind(
	"XF86AudioLowerVolume",
	hl.dsp.exec_cmd(volume_decrease),
...
hl.bind(
	"XF86MonBrightnessUp",
	hl.dsp.exec_cmd(brightness_increase),
	{ locked = true, repeating = true, desc = "Reducir el brillo" }
)
hl.bind(
	"XF86MonBrightnessDown",
	hl.dsp.exec_cmd(brightness_decrease),
