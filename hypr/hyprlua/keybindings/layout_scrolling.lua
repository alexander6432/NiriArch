...
M.binds.swapcol_l       = hl.bind(mainMod .. "A", hl.dsp.layout("swapcol l"), { desc = "Intercambiar ventana con la de la izquierda[scrolling]"})
M.binds.swapcol_r       = hl.bind(mainMod .. "S", hl.dsp.layout("swapcol r"), { desc = "Intercambiar ventana con la de la derecha[scrolling]"})
