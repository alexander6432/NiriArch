...
hl.bind(mainMod .. wss, hl.dsp.workspace.toggle_special(special), { desc = "Ir al workspace de ventanas minimizadas" })
...
end, { desc = "Restaurar las ventanas minimizadas o minimizar la primera ventana" })
