...
function M.setup()
  ...
  hl.bind(mainMod .. "Tab", on_master("orientationcycle left top right bottom"),
    { desc = "Rotar orientación en sentido horario para la ventana maestra[master]" })
  hl.bind(mainMod .. shift .. "Tab", on_master("orientationcycle bottom right top left"),
    { desc = "Rotar orientación en sentido antihorario para la ventana maestra[master]" })

  hl.bind(mainMod .. "H", on_master("orientationleft"),
    { desc = "Ventana maestra con orientación a la izquierda[master]" })
  hl.bind(mainMod .. "L", on_master("orientationright"),
  ...
  hl.bind(mainMod .. "J", on_master("orientationbottom"),
