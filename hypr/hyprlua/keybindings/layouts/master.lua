...
function M.setup()
	...
	hl.bind(
		mainMod .. shift .. "S",
		on_master("swapnext loop"),
		{ desc = "Intercambiar con la siguiente ventana[master]" }
	)
	hl.bind(
		mainMod .. shift .. "A",
		on_master("swapprev loop"),
		{ desc = "Intercambiar con la anterior ventana[master]" }
	)
	...
	hl.bind(
		mainMod .. "Tab",
		on_master("orientationcycle left top right bottom"),
		{ desc = "Rotar orientación en sentido horario para la ventana maestra[master]" }
	)
	hl.bind(
		mainMod .. shift .. "Tab",
		on_master("orientationcycle bottom right top left"),
		{ desc = "Rotar orientación en sentido antihorario para la ventana maestra[master]" }
	)

	hl.bind(
		mainMod .. "H",
		on_master("orientationleft"),
		{ desc = "Ventana maestra con orientación a la izquierda[master]" }
	)
	hl.bind(
		mainMod .. "L",
		on_master("orientationright"),
		{ desc = "Ventana maestra con orientación a la derecha[master]" }
	)
	hl.bind(
		mainMod .. "K",
		on_master("orientationtop"),
		{ desc = "Ventana maestra con orientación hacia arriba[master]" }
	)
	hl.bind(
		mainMod .. "J",
		on_master("orientationbottom"),
		{ desc = "Ventana maestra con orientación hacia abajo[master]" }
	)
