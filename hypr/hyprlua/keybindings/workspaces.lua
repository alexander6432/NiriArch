...
for i = 1, total_ws do
	...
	hl.bind(
		...
		{ desc = "Mover ventana al workspace " .. key }
	)
	hl.bind(
		mainMod .. ctrl .. key,
...
hl.bind(
	mainMod .. shift .. plus,
	relative_workspace("after", "move", true),
	{ desc = "Mover ventana al siguiente workspace" }
)

hl.bind(
	mainMod .. shift .. minus,
	relative_workspace("before", "move", true),
	{ desc = "Mover ventana al anterior workspace" }
)

hl.bind(
	mainMod .. ctrl .. plus,
	relative_workspace("after", "move", false),
	{ desc = "Mover ventana al siguiente workspace sin enfocarlo" }
)

hl.bind(
	mainMod .. ctrl .. minus,
	relative_workspace("before", "move", false),
